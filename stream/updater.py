...
from data import WAR, WAR_COMMANDS, REGROUP, CHATS, WIND
from helpers import get_equipment
...
class Updater(object):
    ...
    def bot_message(self):
        ...
        message, content = self.get_message(self.chats["cw"])
        return message.id, content

    @property
    def group_message(self):
        """ Последнее сообщение от Супергруппы """
        return self.get_message(self.chats["group"], False)
